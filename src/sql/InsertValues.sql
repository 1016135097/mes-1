...
values 
( null,'购买，30度-硬质合金车刀，20件',20,5.00,'2015-7-08',1,6),
( null,'购买，车刀杆，20件',20,150.00,'2015-7-08',5,6),
( null,'购买，d8-钻头，20件',20,50.00,'2015-7-08',7,6),
( null,'购买，倒角刀，20件',20,50.00,'2015-7-08',11,6);
...
#插入生产计划表数据;
insert into plan (id,title,num,enddate,isOnPlan,isOnProducting,pdoc_id,userinfo_id)
values 
( null,'ERT型-T01-前传动轴-生产200件',200,'2015-6-25',1,1,1,3),
( null,'ERT型-T02-中传动轴-生产300件',300,'2015-6-15',1,0,1,3),
( null,'ERT型-T02-中传动轴-生产400件',400,'2015-6-19',1,0,2,3),
( null,'ERT型-T03-后传动轴-生产100件',100,'2015-6-24',0,0,2,3),
( null,'ERT型-T03-后传动轴-生产150件',150,'2015-6-30',0,0,3,5),
( null,'ERT型-T03-后传动轴-生产562件',562,'2015-6-17',0,0,2,5);
